...
#load demographics
demos_scan <-read.table(file="~/Documents/OneDrive/Documents/Project Trust Game/analyses/manuscript clinical/trust_scan_demos_all.csv", sep = ',', header = TRUE)
demos_beha <-read.table(file="~/Documents/OneDrive/Documents/Project Trust Game/analyses/manuscript clinical/trust_beha_demos_all.csv", sep = ',', header = TRUE)
