...
# plot pt_decision*exchange by trustee
#<<<<<<< Updated upstream
pt_decisionXexchange.lsm <- lsmeans(likelihood.m4, "mc_exchange", by = "pt_decision")
pt_decisionXexchange.sum <- summary(pt_decisionXexchange.lsm, infer = c(TRUE,TRUE), level = 0.95, adjust = "bon")
