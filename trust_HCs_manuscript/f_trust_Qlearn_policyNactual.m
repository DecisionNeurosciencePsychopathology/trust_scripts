function  [fx] = f_trust_Qlearn_actualNpolicy(x,theta,u,inF)
...
if (u(2)==1 && u(1)==1)     %trustee shared, subject shared
    r = 2.5;                % BUT why don't they consider their alternative action as a reference?
elseif (u(2)<1 && u(1)==1) %trustee kept, subject shared
    r = -1;
elseif (u(2)<1 && u(1)<1)  %trustee kept, subject kept
    r = 2;
else
    r = 0;               %trustee shared, subject kept
end
