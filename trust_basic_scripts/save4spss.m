...
% usage: save4spss(names, vars, titl)
% names -- names of variables
% vars -- matrix with variables as columns
% titl -- filename
% AD: it had a European way of replacing decimal "." with "*"
% AD: I removed that...
...
%
% The second input argument must be a data matrix.
% The first input argument must be a cell array with variable names as
